 ...
 */
export async function creerCleAPI(_etatPrecedent: ResultatCreation, formData: FormData): Promise<ResultatCreation> {
  if (!redis) {
    return {
      erreur: "Service non configuré — variables d'environnement Upstash manquantes.",
    };
  }
